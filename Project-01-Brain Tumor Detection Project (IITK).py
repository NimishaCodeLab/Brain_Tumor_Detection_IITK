...
#correlation is not cause . (beach death and ice cream.)
#remove duplicated same correlated data to avoid overfitting.
#In normal distribution , when skewed generally we take median or mode but not mean.
...
#model.fit() - finds m and c (learn what it actually do)
#.transform()  -
...
#Machine Learning Project: Brain Tumor Cancer Prediction
#------------------------  ------------------------------
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
...
print("\n\n\nSample BrainTumor dataset head(15) :- \n\n", data.head(15) )
